...
private:
   ...
   {  // setup
      ...
      // verify
      assertEquals(l.pos.x, 110.0); // 100 + 0*2 + .5*5*4
      assertEquals(l.pos.y, 212.0); // 200 + 0*2 + .5*6*4
      assertEquals(l.velocity.dx, 10.0);  // 0 + 5*2 = 10.0
      assertEquals(l.velocity.dy, 12.0);  // 0 + 6*2 = 12.0
   ...
   {  // setup
     Lander l(p);
      ...
      // verify
      assertEquals(l.pos.x, 170.0); // 100 + 30*2 + .5*5*4 = 100 + 60 + 10
      assertEquals(l.pos.y, 292.0); // 200 + 40*2 + .5*6*4 = 200 + 80 + 12
