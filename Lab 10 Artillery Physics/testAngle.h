...
private:
	...
	{ // setup
		Angle a;
		a.radians = 11 * M_PI / 6; // 330 degrees
		bool isRight = true;
		...
		assertEquals(a.radians, 11 * M_PI / 6.0);
	} // teardown
	...
	{ // setup
		...
		assertEquals(a.radians, 11 * M_PI / 6);
	} // teardown
